...
class DocumentDecoration {
    ...
    setVerticalLineDecoration(scope, event, verticleLineRanges) {
        const offsets = [];
        ...
        let aboveValidRange = new vscode.Range(verticleLineRanges[0].range.start.translate(-1), verticleLineRanges[0].range.end.translate(-1));
